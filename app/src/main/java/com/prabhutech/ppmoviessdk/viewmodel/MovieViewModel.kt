...
class MovieViewModel @Inject constructor(
    ...
    private val _movieShowsResponseTest = MutableStateFlow<MovieListEvent>(MovieListEvent.Loading)
    val movieShowsResponseTest: StateFlow<MovieListEvent> = _movieShowsResponseTest
